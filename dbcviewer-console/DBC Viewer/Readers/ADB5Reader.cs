...
namespace DBCViewer
{
    class ADB5Reader : IWowClientDBReader
    {
        ...
        public ADB5Reader(string fileName)
        {
            using (var reader = BinaryReaderExtensions.FromFile(fileName))
            {
                ...
                int locale = reader.ReadInt16();    // new field in WDB2
                int CopyTableSize = reader.ReadInt16();
